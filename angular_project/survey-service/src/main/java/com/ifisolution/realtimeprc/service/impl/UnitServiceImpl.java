...
public class UnitServiceImpl implements UnitService {
    ...
    @Override
    @Transactional
    public UnitReport saveNewUnitAndUnitReport(UnitInfoDTO unitDTO, AddressDTO address,int userId) {
       if(checkIfUnitExists(unitDTO.getUnitName()) ){
           ...
           Unit unit1 = new Unit(unitDTO.getUnitName(),userId);
           Unit savedUnit;
           try{
    ...
    UnitReport saveUnitReport(Unit savedUnit, UnitInfoDTO unitDTO) {
        ...
        unitReport.setStatus(unitDTO.getStatus());
    ...
    public Unit getSelectedUnit(String unitName) {
        ...
        try{
            ...
            throw new ServiceException("access fail to database" + e.getMessage());
