package com.ifisolution.pcr.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("PCRFE");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("PCRFE");
        ...
        config.getMapConfigs().put("com.ifisolution.pcr.domain.*", initializeDomainMapConfig(jHipsterProperties));
